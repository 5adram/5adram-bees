...
public final class GameState {
  ...
  /** return the gameField and gameStatus. */
   ...
   *
   * @return chekc if the game still running
   */
   ...
   *
   * @return check if the game is wined
   */
   ...
   *
   * @return check if the game status is game over
   */
